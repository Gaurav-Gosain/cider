...
FMTaskRef FMLanguageModelSessionRespondWithOptions(FMLanguageModelSessionRef _Nonnull session, const char *_Nonnull prompt, double temperature, int maxTokens, void *_Nullable userInfo, FMLanguageModelSessionResponseCallback callback);
...
FMLanguageModelSessionResponseStreamRef _Nonnull FMLanguageModelSessionStreamResponseWithOptions(FMLanguageModelSessionRef _Nonnull session, const char *_Nonnull prompt, double temperature, int maxTokens);
